...
<li class="nav-item active">
    <a class="nav-link" href=<c:url value='/llp/add'></c:url>
        ...
        <span>Dodaj nowy podzespół</span></a>
</li>
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Dodaj nowy podzespół:</h6>
                    </div>
                    <div class="card-body">
                        <div class="text-lg-left">
                            <form:form method="post" modelAttribute="llp">
                                ...
                                <div>do szybowca: <form:radiobuttons path="glider" items="${gliders}" itemLabel="regNumber" itemValue="id"/><form:errors path="glider"/></div>
